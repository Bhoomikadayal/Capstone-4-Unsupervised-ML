 <B>**NETFLIX MOVIES AND TV SHOWS CLUSTERING (Unsupervised ML):**</B>
...
- Utilizing the K-Means Clustering algorithm, we first constructed clusters, and the optimal number of clusters was determined. The elbow method and 
